...
The `:active` pseudo-class applies styles to an element when it is being activated by the user, typically hen a user clicks on an element and holds the mouse button down.
